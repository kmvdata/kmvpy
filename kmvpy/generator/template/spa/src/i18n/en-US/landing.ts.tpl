...
export default {
  ...
  hero: {
    ...
    title: "KMVPy",
    subtitle:
      "A FastAPI backend foundation and project scaffold that moves a backend from an empty directory to runnable, configurable, and deployable.",
  ...
  quickstart: {
    ...
    desc: "KMVPy is built for backend developers and engineering teams that want a runnable, configurable, and deployable service foundation first.",
    stepInstall:
  ...
  capabilities: {
    ...
    desc: "KMVPy is not a plain template. It is a foundation library, runtime convention, and project generator for service entrypoints, config, storage, security, realtime APIs, and schedules.",
  ...
  examples: {
    ...
    desc: "Commands, ASGI entrypoints, and JWT config stay explicit so teams can judge whether KMVPy fits their service foundation.",
  ...
  usecases: {
    ...
    scaffoldBody:
      "Teams that need Python backend, SPA, Nginx, and deployment config generated together.",
